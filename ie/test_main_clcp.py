...
from ie.src.run_predicate_classification_clcp import predicate_classification_model_test
...
def re_step(job_id='None', schema_set='None'):
    ...
    clf_model_path = os.path.join(train_data_path, "model/predicate_infer_out_clcp/")
    ...
    print(model_list)
#    clf_model_idx = 'model.ckpt-161000'
    model_list = ['model.ckpt-148800']
...
#    try:
 ...
 #   except:
#:print("ERROR, except!!!!!!".format(job_id, schema_set))
  #      return 0
